  ...
  const handleSearch = (criteria) => {
    ...
    if (criteria.quickSearch && criteria.quickSearch.trim() !== '') {
      ...
      filtered = filtered.filter((property) => {
        ...
        if (searchTerm.includes('k') && priceString.includes(searchTerm.replace('k', '000'))) return true
        if (searchTerm.includes('m') && priceString.includes(searchTerm.replace('m', '000000'))) return true
    ...
    filtered = filtered.filter(property => {
      ...
      if (criteria.maxBedrooms !== Infinity && property.bedrooms > criteria.maxBedrooms) return false
      return true
    })
