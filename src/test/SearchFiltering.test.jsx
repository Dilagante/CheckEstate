...
describe('Search Filtering Logic', () => {
  ...
  it('filters properties by type (House)', () => {
    ...
    const filtered = properties.filter((property) => {
      return property.type. toLowerCase() === criteria.propertyType.toLowerCase()
    })
  ...
  it('filters properties by price range', () => {
    ...
    const filtered = properties. filter((property) => {
      return property.price >= criteria.minPrice && property.price <= criteria. maxPrice
    })
  ...
  it('filters properties by number of bedrooms', () => {
    ...
    const filtered = properties.filter((property) => {
      return property.bedrooms >= criteria.minBedrooms && property.bedrooms <= criteria.maxBedrooms
    })
